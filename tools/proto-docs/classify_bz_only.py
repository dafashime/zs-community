...
data = json.load(open(r"D:\Dev\ZhanS\_tmp\proto-docs\bz_usage_diff.json", encoding="utf-8"))
...
with open(r"D:\Dev\ZhanS\_tmp\proto-docs\bz_only_real.txt", "w", encoding="utf-8") as f:
