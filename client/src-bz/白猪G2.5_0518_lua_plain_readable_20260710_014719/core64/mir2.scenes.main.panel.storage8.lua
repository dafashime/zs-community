...
function storage:ctor(merchant, count, gridCnt, buf, bufLen)
	...
	local bg = res.get2("pic/panels/bag/bg_storage.png"):anchor(0, 0):addto(self, 1)
	...
	an.newBtn(res.gettex2("pic/panels/bag/close10.png"), function()
		...
		size = cc.size(64, 64)
	}):anchor(1, 1):pos(bg:getw() + 25, bg:geth() - 0):addto(self, 2)
	...
	}):addTo(self, 2):pos(20, 31):anchor(0, 0.5)
	an.newBtn(res.gettex2("pic/panels/bag/zlbb.png"), function()
		sound.playSound("103")
...
function storage:idx2pos(idx)
	...
	return 42 + h * 48, 329 - v * 49
end

function storage:pos2idx(x, y)
	local h = (x - 42) / 48 + 0.5
	local v = (329 - y) / 49 + 0.5
