...
function notifier:addNotifyListener(func)
	self.listeners_ = self.listeners_ or {}
	self.listeners_[#self.listeners_ + 1] = func
end

function notifier:removeNotifyListener(func)
...
function relation:sort_(list)
	...
	local function compare(l, r)
		local lonline, ronline = l:get("isonline"), r:get("isonline")
		local llevel, rlevel = l:get("level"), r:get("level")
